      ...
      <main className={classes.content}>
        ...
        <Container maxWidth="lg" className={classes.container}>
          <Grid container spacing={3}>
            <Grid item sm={12}>
              <Button style={{marginBottom:10}} variant="contained" color="primary" href={'/admin/usuarios/cadastrar'}><AddIcon />
              Novo Usuário</Button>
                        ...
                        {usuarios.map((row) => (
                          <TableRow key={row._id}>
                            ...
                            <ButtonGroup aria-label="outlined primary button group">
                              <Button variant="contained" color="primary" href={'/admin/usuarios/editar/'+row._id}><EditIcon /></Button>
